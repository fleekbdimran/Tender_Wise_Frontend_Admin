  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96 relative">
        ...
        <h2 className="text-xl font-semibold mb-6">Add Division</h2>
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      const response = await ApiClient.patch(
        `/admin/tender-config/division/${category.id}`,
        {
          name: categoryName,
  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96 relative">
        ...
        <h2 className="text-xl font-semibold mb-6">Edit Division</h2>
        <form onSubmit={handleFormSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700">
              <span className="text-red-500">*</span> Name:
    ...
    const fetchCategories = async () => {
      ...
      try {
        const response = await ApiClient.get(
          `/admin/tender-config/division?${queryParams.toString()}`
        );
