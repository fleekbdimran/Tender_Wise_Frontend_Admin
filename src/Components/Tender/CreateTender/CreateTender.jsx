      ...
      {showCreateForm ? (
        ...
        <>
          <div className="overflow-x-auto">
            <table className="min-w-full h-4/5 bg-white border border-gray-200">
              <thead>
                <tr className="bg-gray-100">
                  <th className="p-3 border-b text-center">S/N</th>
                  <th className="p-3 border-b text-center">Tender ID</th>
              ...
              <tbody>
                {paginatedAdminList.map((admin, index) => (
                  <tr key={admin.id} className="text-center">
                    ...
                    <td className="p-3 border-b">{admin.tender_id}</td>
                    <td className="p-3 border-b">{admin.name}</td>
                    <td className="p-3 border-b">{admin.type}</td>
